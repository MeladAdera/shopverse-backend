...
export const cartController = {
  // 🛒 Get cart contents
  getCart: catchAsync(async (req: AuthenticatedRequest, res: Response) => {
  ...
  updateCartItem: catchAsync(async (req: AuthenticatedRequest, res: Response) => {
    const userId = req.user!.id;
  ...
  removeFromCart: catchAsync(async (req: AuthenticatedRequest, res: Response) => {
    const userId = req.user!.id;
    const cartItemId = parseInt(req.params.itemId);
  ...
  // 🛒 Clear entire cart
  clearCart: catchAsync(async (req: AuthenticatedRequest, res: Response) => {
    const userId = req.user!.id;
  ...
  getCartItemsCount: catchAsync(async (req: AuthenticatedRequest, res: Response) => {
    const userId = req.user!.id;
